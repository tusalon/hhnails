...
const CACHE_NAME = 'hhnails-v49';
const urlsToCache = [
  '/hhnails/',
  '/hhnails/index.html',
  '/hhnails/admin.html',
  '/hhnails/admin-login.html',
  '/hhnails/calendar.html',
  ...
  '/hhnails/vendor/react.production.min.js',
  '/hhnails/vendor/react-dom.production.min.js',
  '/hhnails/vendor/babel.min.js',
  '/hhnails/vendor/bcrypt.min.js',
  '/hhnails/vendor/tailwind-browser.js',
  '/hhnails/vendor/lucide/lucide.css',
  '/hhnails/vendor/lucide/lucide.woff2',
  '/hhnails/utils/push-config.js',
  '/hhnails/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/hhnails/icons/icon-192x192.png',
    badge: '/hhnails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/hhnails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/hhnails/admin.html';
  event.waitUntil(
